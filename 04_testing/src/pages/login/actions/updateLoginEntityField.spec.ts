...
import {
  updateLoginEntityFieldCompleted,
  updateLoginEntityField
} from "./updateLoginEntityField";
...
describe("login/actions/updateLoginEntityField tests", () => {
  describe("updateLoginEntityFieldCompleted", () => {
    ...
    when passing fieldName, value and fieldValidationResult`, () => {
      ...
      // Act
      const result = updateLoginEntityFieldCompleted(
        fieldName,
        value,
  ...
  describe("updateLoginEntityField", () => {
    it("should call to validateField with loginEntity, fieldName and value", done => {
      ...
      store
        .dispatch<any>(updateLoginEntityField(loginEntity, fieldName, value))
        .then(() => {
          // Assert
          expect(validateFieldStub).toHaveBeenCalledWith(
            loginEntity,
            fieldName,
            value
          );
   ...
   payload with fieldName, value and fieldValidationResult`, done => {
      ...
      const validateFieldStub = jest
        .spyOn(validations, "validateField")
